...
public class Assignment37_InheritanceCases {
	...
	void case5() {
		...
		Assignment37_Manager case51 = new Assignment37_Manager();
		Assignment37_Employee case52 = new Assignment37_Employee();
	...
	void case6() {
		...
		Assignment37_Manager case61 = new Assignment37_Employee();  //A a = new B();
		Assignment37_Employee case62 = new Assignment37_Employee(); //B b = new B();
		//case62 = case61; // b = a; 
		//CE at above line, type mismatch, need to type cast,
		//as parent reference type cannot be stored in child reference type
		
		case62 = (Assignment37_Employee) case61; //b = (B)a;
