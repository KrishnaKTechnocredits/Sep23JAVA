...
public class Assignment37_InheritanceCases {

// When we create an object of parent class then we can access/call parent class data members only.
	void case1() {
		System.out.println("CASE-1");
		Assignment37_Manager case1 = new Assignment37_Manager();
		System.out.println(case1.x); // 10
		System.out.println(case1.y); // 20
//		System.out.println(case1.z);	// CE, as Manager class does not have this employee class variable
		case1.m1(); // Manager - m1
		case1.m2(); // Manager - m2
//		case1.m3();	//CE, as Manager class does not have this employee class method
	}

//When we create an object of child class then we can access/call parent class and child class data members.
	void case2() {
...
//When we create an object of child class with parent class reference, it is known as dynamic polymorphism.
...
//		System.out.println(case3.z); //CE, because Parent class reference is not aware of this variable.
...
//		case3.m3(); //CE, as manager class is not aware of employee class method.
	...
	void case4() {
		...
		// Assignment37_Employee case4 = new Assignment37_Manager(); //CE, type Casting
		// is required casting is required.
//		Assignment37_Employee case4 = (Assignment37_Employee) new Assignment37_Manager(); // RunTime Error - java.lang.ClassCastException

	}

// We can acheive dynamic polymorphism, by using variables also. This is similar to case 3.
	void case5() {
...
//		case5_parent.m3(); //CE, as manager class is not aware of this emloyee class method.
	}
	...
	public static void main(String[] args) {
		Assignment37_InheritanceCases cases = new Assignment37_InheritanceCases();
		cases.case1();
		cases.case2();
		cases.case3();
		cases.case4();
