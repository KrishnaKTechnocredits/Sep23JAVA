...
public class As87WordWithMaxFreq {
	...
	public static void main(String[] args) {
		As87WordWithMaxFreq as87 = new As87WordWithMaxFreq();
		Map<String, Integer> wordMap = as87
				.getFrequencyofWord("hello techno techno hi credits hi techno hello techno pune");
		System.out.println("Word having Maximum frequecy is : " + as87.getWordWithMaxFrequency(wordMap));
	}
}
