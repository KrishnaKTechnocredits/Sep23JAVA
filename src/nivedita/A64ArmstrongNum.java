...
public class A64ArmstrongNum {
	...
	public static void main(String[] args) {
		A64ArmstrongNum armstrongNum = new A64ArmstrongNum();
		armstrongNum.armstrongNumbers(900, 1100);
		armstrongNum.armstrongNumbers(10, 1000);
